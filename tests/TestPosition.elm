...
enPassantPossiblePosition =
    let
        plies =
            [ Ply.Standard { start = Square 1 4, end = Square 3 4, player = Player.White, piece = Piece Piece.Pawn Player.White, takes = Nothing, promotion = Nothing }
            , Ply.Standard { start = Square 6 0, end = Square 5 0, player = Player.Black, piece = Piece Piece.Pawn Player.Black, takes = Nothing, promotion = Nothing }
            , Ply.Standard { start = Square 3 4, end = Square 4 4, player = Player.White, piece = Piece Piece.Pawn Player.White, takes = Nothing, promotion = Nothing }
            , Ply.Standard { start = Square 6 5, end = Square 4 5, player = Player.Black, piece = Piece Piece.Pawn Player.Black, takes = Nothing, promotion = Nothing }
            ]
    in
    List.foldl
        (\ply pos ->
...
enPassantPossiblePositionErrorCase =
    let
        plies =
            [ Ply.Standard { start = Square 1 4, end = Square 3 4, player = Player.White, piece = Piece Piece.Pawn Player.White, takes = Nothing, promotion = Nothing }
            , Ply.Standard { start = Square 6 0, end = Square 4 0, player = Player.Black, piece = Piece Piece.Pawn Player.Black, takes = Nothing, promotion = Nothing }
            , Ply.Standard { start = Square 3 4, end = Square 4 4, player = Player.White, piece = Piece Piece.Pawn Player.White, takes = Nothing, promotion = Nothing }
            , Ply.Standard { start = Square 6 5, end = Square 4 5, player = Player.Black, piece = Piece Piece.Pawn Player.Black, takes = Nothing, promotion = Nothing }
            , Ply.EnPassant { end = { file = 5, rank = 5 }, player = Player.White, start = { file = 4, rank = 4 }, takenPawn = { file = 5, rank = 4 } }
            , Ply.Standard { start = Square 4 0, end = Square 3 0, player = Player.Black, piece = Piece Piece.Pawn Player.Black, takes = Nothing, promotion = Nothing }
            , Ply.Standard { start = Square 1 1, end = Square 3 1, player = Player.White, piece = Piece Piece.Pawn Player.White, takes = Nothing, promotion = Nothing }
            ]
    in
    List.foldl
        (\ply pos ->
    ...
    describe "Position module"
            ...
            [ test "Initial position" <|
                \_ ->
                    let
                        ...
                        makePly end =
                            Ply.Standard { player = Player.White, piece = Piece Piece.Pawn Player.White, start = start, end = end, takes = Nothing, promotion = Nothing }
        ...
        , describe "makeMove"
            [ test "ply with wrong turn should return Nothing" <|
                \_ ->
                    Expect.equal Nothing (Position.makeMove Position.initial (Ply.Standard { start = Square 6 0, end = Square 5 0, player = Player.Black, piece = Piece Piece.Pawn Player.Black, takes = Nothing, promotion = Nothing }))
